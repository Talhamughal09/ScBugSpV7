...
let ctf = `❗Hello @${m.sender.split('@')[0]} , 𝙎𝙖𝙣𝙕 𝙆𝙖𝙡𝙨𝙚𝙡 𝙊𝙁𝙁𝙄𝘾𝙄𝘼𝙇 Just Gave You Access To The Following Account Panel > >
